package com.capstone.symptomman.patient.auth;
	...
	protected static class OAuth2Config extends
		...
		public OAuth2Config() throws Exception {
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
							User.create("doctor1", "pass", Role.DOCTOR.toString()),
							User.create("user0", "pass", Role.PATIENT.toString()),
							User.create("user1", "pass", Role.PATIENT.toString()),
							User.create("user2", "pass", Role.PATIENT.toString()),
							User.create("doctor2", "pass", Role.DOCTOR.toString()),
							User.create("user3", "pass", Role.PATIENT.toString()),
							User.create("user4", "pass", Role.PATIENT.toString()),
							User.create("user5", "pass", Role.PATIENT.toString())));
